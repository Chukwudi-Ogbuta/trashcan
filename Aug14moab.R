...
parse_h2h_row <- function(row_node) {
  ...
  if (is.null(home_node)) home_node <- row_node %>% html_node("div.h2h__homeParticipant span.wcl-name_jjfMf")
  away_node  <- row_node %>% html_node("span.h2h__awayParticipant span.h2h__participantInner")
  if (is.null(away_node)) away_node <- row_node %>% html_node("div.h2h__awayParticipant span.wcl-name_jjfMf")
